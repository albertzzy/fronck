...
/******/ 	var hotCurrentHash = "a84f8aa4409de6d1132e"; // eslint-disable-line no-unused-vars
...
var OrderLine = (_class = function () {
    function OrderLine() {
        _classCallCheck(this, OrderLine);

        _initDefineProp(this, "price", _descriptor, this);
    ...
    return OrderLine;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "price", [_mobx.observable], {
    enumerable: true,
